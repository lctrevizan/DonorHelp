...
const buscarBancos = async () => {
  ...
  if (url) {
    try {
      ...
      Alert.alert('Erro', 'Não foi possível abrir o mapa. Por favor, tente novamente.');
    }
  } else {
    Alert.alert('Erro', 'Não foi possível determinar a URL específica da plataforma');
  }
};
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.secao}>
            ...
            <Pressable style={styles.button} onPress={buscarBancos}>
              <Ionicons name="search-outline" size={24} color="white" style={styles.buttonIcon} />
